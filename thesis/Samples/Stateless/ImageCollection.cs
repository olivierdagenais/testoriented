...
private static readonly XName ItemNodeName =
  DeepZoom2008 + "I";
private static readonly XName SizeNodeName =
  DeepZoom2008 + "Size";

private readonly string _imageFormatName;
private readonly XElement _sizeNode;
private readonly string _fileNameIdFormat;
private readonly IList<int> _postIds =
  new List<int>();

public ImageCollection(string imageFormatName,
  string fileNameIdFormat, int width, int height)
{
  _imageFormatName = imageFormatName;
  _fileNameIdFormat = fileNameIdFormat;

  // the <Size> element is the same for all <I>
...
internal static XElement GenerateItemNode
  ...
  string fileNameIdFormat, string relativePathToRoot)
{
  ...
  var fileName =
    postId.ToString(fileNameIdFormat);
