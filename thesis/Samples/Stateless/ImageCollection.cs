...
public class ImageCollection
{
    ...
    public XElement GenerateXml(string relativePathToRoot)
    {
        ...
        {
            var itemNode = GenerateItemNode (mortonNumber, postId,
                _fileNameIdFormat, relativePathToRoot);
    ...
    internal static XElement GenerateItemNode (int mortonNumber, int postId, string fileNameIdFormat, string relativePathToRoot)
    {
        ...
        var fileName = postId.ToString (fileNameIdFormat);
