...
namespace Textile
{
    public partial class TextileFormatter
    {
        ...
        internal static List<Type> s_registeredStates = new List<Type>();
        internal static List<FormatterStateAttribute> s_registeredStatesAttributes = new List<FormatterStateAttribute>();
        ...
        internal List<Type> m_disabledFormatterStates = new List<Type>();
        internal Stack<FormatterState> m_stackOfStates = new Stack<FormatterState>();

        internal bool IsFormatterStateEnabled(Type type)
        {
            return !m_disabledFormatterStates.Contains(type);
        }

        internal void SwitchFormatterState(Type type, bool onOff)
        {
            if (onOff)
        ...
        internal void PushState(FormatterState s)
        {
        ...
        internal string HandleFormattingState(string input)
        {
