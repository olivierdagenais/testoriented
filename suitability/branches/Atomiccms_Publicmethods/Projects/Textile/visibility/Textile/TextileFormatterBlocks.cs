...
namespace Textile
{
    public partial class TextileFormatter
    {
        ...
        internal static List<BlockModifier> s_blockModifiers = new List<BlockModifier>();
        internal static List<Type> s_blockModifiersTypes = new List<Type>();
        ...
        internal List<Type> m_disabledBlockModifiers = new List<Type>();
