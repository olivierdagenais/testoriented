...
namespace KeePassLib.Keys
{
	...
	{
		internal string m_strPath = string.Empty;
		...
		internal const string RootElementName = "KeyFile";
		internal const string MetaElementName = "Meta";
		internal const string VersionElementName = "Version";
		internal const string KeyElementName = "Key";
		internal const string KeyDataElementName = "Data";
