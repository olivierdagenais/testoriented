...
namespace Textile.States
{
	public class TableCellParser
	{
		...
		{
		    return InternalGetLineFragmentFormatting(m_lineFragment);
		}

	    internal static string InternalGetLineFragmentFormatting(string lineFragment)
	    {
	        string htmlTag = "td";

	        Match m = Regex.Match(lineFragment,
	                              @"^((?<head>_?)" +
	                              Globals.SpanPattern +
