...
namespace Textile
{
    ...
    class Globals
    {
        ...
        internal static Dictionary<string, string> m_imageAlign;
        /// <summary>
        ...
        internal static Dictionary<string, string> m_horizontalAlign;
        /// <summary>
        ...
        internal static Dictionary<string, string> m_verticalAlign;
        /// <summary>
